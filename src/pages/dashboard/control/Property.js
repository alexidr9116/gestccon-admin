...
import Register from '../../../sections/control/Property/Register';
import Search from '../../../sections/control/Property/Search';
// sections
...
export default function Property() {
    ...
    return (
        <Page title="Controls | Property and Equipment">
            <Container maxWidth={themeStretch ? false : 'lg'}>
                <HeaderBreadcrumbs
                    heading="Property and Equipment"
                    links={[
                        { name: 'Control' },
