...
export default function Register() {
    ...
    const RegisterForm = Yup.object().shape({
        ...
        company: Yup.string().required('IP Address is required'),    
        ...
        obsevation : Yup.string().required('IP Address is required'),
    });
        ...
        <>
            <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
                <Stack spacing={3} paddingTop={1}>
                    <Typography variant='subtitle1'>Register a pouch</Typography>
                    <Stack sx={{ flexDirection: { md: 'row', xs: 'column' } }} gap={2}>
                    <RHFSwitch name="profile" label="Resident/Comapny" />
                    ...
                    <Stack sx={{ flexDirection: { md: 'row', xs: 'column' } }} gap={2}>
                        ...
                        <RHFTextField name="number" label="Documentation Number" />
